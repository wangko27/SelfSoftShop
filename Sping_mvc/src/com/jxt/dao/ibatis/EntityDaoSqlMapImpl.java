...
import com.jxt.dao.EntityDao;

public class EntityDaoSqlMapImpl<T> extends SqlMapClientDaoSupport implements
		EntityDao<T> {
	...
	public Long selectEntityCount(T t) throws DataAccessException {
		...
		return (Long) super.getSqlMapClientTemplate().queryForObject(statement,
				t);
	}
