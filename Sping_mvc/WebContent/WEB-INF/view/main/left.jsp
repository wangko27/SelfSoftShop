...
border=0>
      <TBODY>
        ...
        <TR>
          <TD 
      height=105><span class="STYLE2"><IMG src="Images/closed.gif">版权所有：www.mycodes.net<br>
              <IMG src="Images/closed.gif">设计制作：mycodes.net<br>
              <IMG src="Images/closed.gif">技术支持：<a href="http://www.mycodes.net" target="_blank">mycodes.net</a><br>
              <IMG src="Images/closed.gif">帮助中心：<a href="http://www.mycodes.net" target="_blank">mycodes.net</a><br>
